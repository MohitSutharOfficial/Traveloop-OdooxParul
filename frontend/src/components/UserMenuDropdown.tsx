...
export default function UserMenuDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#EF9F27] text-sm font-semibold text-white">
          {userInitials}
        </div>
        ...
        <div className="absolute right-0 z-50 mt-2 w-64 overflow-hidden rounded-[14px] border border-[#E8E6E0] bg-white shadow-lg dark:border-stone-700 dark:bg-stone-900">
          <div className="border-b border-[#E8E6E0] px-4 py-3 dark:border-stone-700">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#EF9F27] text-lg font-semibold text-white">
                {userInitials}
              </div>
